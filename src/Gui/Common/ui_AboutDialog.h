...
public:
    ...
    void retranslateUi(QDialog *AboutDialog)
    {
        ...
        m_aboutLabel->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-family:'Open Sans'; font-size:14px;\">Karbo Wallet version %1-%2</span></p><p><span style=\" font-family:'Open Sans'; font-size:14px;\">Karbo (Karbovanets) is the next generation anonymous cryptocurrency based on CryptoNote.</span></p><p><span style=\" font-family:'Open Sans'; font-size:14px;\">Copyright \302\251 2017-%3 The Karbowanec developers</span></p><p><span style=\" font-family:'Open Sans'; font-size:14px;\">Copyright \302\251 2012-2017 The Bytecoin developers</span></p><p><span style=\" font-family:'Open Sans'; font-size:14px;\">This is free software.</span></p><p><span style=\" font-family:'Open Sans'; font-size:14px;\">Distributed under the GNU Lesser General Public License as published by the Free Software Foundation, either version 3 of the License, or any later version.</span></p><p><span style=\" font-family:'Open Sans'; font-size:14px;\">Distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHA"
                        "NTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU Lesser General Public License for more details:</span></p><p><a href=\"https://www.gnu.org/licenses/lgpl.html\"><span style=\" font-family:'Open Sans'; font-size:14px; text-decoration: underline; color:#0000ff;\">https://www.gnu.org/licenses/lgpl.html</span></a></p><p><a href=\"https://karbo.io/\"><span style=\" font-family:'Open Sans'; font-size:14px; text-decoration: underline; color:#0000ff;\">https://karbo.io/</span></a></p></body></html>", nullptr));
